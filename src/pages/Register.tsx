      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <div className="w-12 h-12 rounded-2xl bg-primary-green/15 border border-primary-green/30 mx-auto flex items-center justify-center">
            <UserPlus size={18} className="text-primary-green" />
          </div>
          <h1 className="text-2xl font-bold text-text-primary mt-4">Create your account</h1>
          <p className="text-text-muted text-sm mt-1">Start reporting issues and earning civic points.</p>
        </div>
        ...
        <GlassCard elevated className="p-6">
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <p className="text-sm text-text-muted text-center">
              ...
              <Link className="text-primary-green hover:text-accent-lime font-semibold" to="/login">
                Sign in
              </Link>
            </p>
          </form>
